...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#Editpre").click(function(){
			...
			frm.action="<%=ctxPath%>/EditPrescriptionEnd.pet";
			frm.method="POST";
			frm.submit();
		});
...
<div class="row">  
   ...
   <div class="col-md-12 ">
   <h4 style="text-align:center; padding-top: 6%;">[ ${premap.pet_name} ] 님의 처방전 수정</h4>
   ...
   <div  class="span col-md-12">8.하루 복용 횟수 :<input type="text" name="dose_number"/></div>  
    ...
    <button type="button" id="Editpre" class="btn1">수정하기</button> 
