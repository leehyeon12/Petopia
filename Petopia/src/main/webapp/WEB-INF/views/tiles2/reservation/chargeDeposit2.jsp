...
<div class="container" style="margin-top: 7%;">
	<div class="text-left col-md-offset-1">
	    ...
	    <h4>예치금 충전</h4>
	 <hr style="border-bottom: 1px solid #ff6e60;"/>
	 </div>
  ...
  <div class="text-center">
      <button type="button" class="btn btn-default" style="color: white; background-color: #ff6e60; border-color: #ff6e60;" onClick="goPay();">확인</button>
