    ...
    for (var i = 0; i < pcs.length; i++) {
      ...
      details.pc.getPeerConnectionStats(function(stats) {
        ...
        var hosts = [
          ...
          'autopush-realtimemediaservices-pa.sandbox.googleapis.com',
          'daily-realtimemediaservices-pa.sandbox.googleapis.com',
        ];
        var host = hosts[Math.floor(Math.random() * hosts.length)];
        xmlhttp.open('POST',
            'https://' + host + '/v1alpha/log?key=AIzaSyDU620juYM1FmyURBQW-MOQF4qQx1ag-_M',
            true);
